...
/*****************************************************************************
 * Endoder/decoder base64 functions retrieved from
...
int main(int argc, char *argv[]){
    ...
    if(strcmp(argv[1],"--encode")==0){
        ...
        int fen;
        fen = open(ENCODED_NAME, O_WRONLY | O_CREAT, 0644);
        ...
        int fde = open(DECODED_NAME, O_WRONLY | O_CREAT,0644);
